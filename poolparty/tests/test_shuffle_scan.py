...
class TestShuffleScanMarkerRemoval:
    ...
    def test_shuffle_scan_with_region_marker(self):
        ...
        with pp.Party() as party:
            ...
            result = shuffle_scan(bg, shuffle_length=2, region='region', mode='sequential').named('result')
...
class TestShuffleScanNaming:
    ...
    def test_prefix_position_and_shuffle(self):
        ...
        assert len(df) == 6
        names = df['name'].tolist()
        expected = ['pos_0.var_0', 'pos_0.var_1', 'pos_1.var_0', 'pos_1.var_1', 'pos_2.var_0', 'pos_2.var_1']
        assert names == expected
    ...
    def test_all_prefixes(self):
        ...
        assert len(df) == 4
        names = df['name'].tolist()
        expected = ['shuf_0.pos_0.var_0', 'shuf_1.pos_0.var_1', 'shuf_2.pos_1.var_0', 'shuf_3.pos_1.var_1']
        assert names == expected
