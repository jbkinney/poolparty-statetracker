...
class TestBreakpointScanSpacing:
    ...
    def test_min_spacing_filters_close_breakpoints(self):
        ...
        df = seg0.generate_seqs(num_complete_iterations=1, aux_pools=[seg1, seg2])
    ...
    def test_triple_breakpoint_spacing(self):
        ...
        df = seg0.generate_seqs(num_complete_iterations=1, aux_pools=[seg1, seg2, seg3])
...
class TestSynchronizePoolsParameter:
    ...
    def test_synchronized_with_mutation_scan_raises_conflict(self):
