...
When generating a library, it is often useful to record how each sequence was constructed. PoolParty provides three complementary features that enable this:
