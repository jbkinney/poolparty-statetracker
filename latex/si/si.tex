...
\begin{minted}{python}
from statetracker import Counter, Manager

with Manager():
    # Create leaf counters
    A = Counter(num_values=2, name='A')
    B = Counter(num_values=3, name='B')
...
To create a counter, use \mintinline{python}{Counter(num_values=n, name='X')}.
