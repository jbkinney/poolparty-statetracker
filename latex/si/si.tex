...
\begin{itemize}
    ...
    \end{center}
    \item During the execution of \inpy{oligo_pool.generate_library()}, each sequence is computed one-at-a-time using a computation tree that can be visualized by running \inpy{oligo_pool.print_tree()}:
    \begin{center}
